...
int Header_InsertItem(HWND w, int i, HDITEM* phdi) {
...
BOOL Header_SetItem(HWND w, int i, HDITEM* phdi) {
...
BOOL ListView_SetItem(HWND w, LV_ITEM* i) {
	return cast(BOOL) SendMessage(w, LVM_SETITEM, 0, cast(LPARAM) i);
}

int ListView_InsertItem(HWND w, LV_ITEM* i) {
...
int ListView_FindItem(HWND w, int i, LV_FINDINFO* p) {
...
BOOL ListView_SetColumn(HWND w, int i, LV_COLUMN* p) {
	return cast(BOOL) SendMessage(w, LVM_SETCOLUMN, i, cast(LPARAM) p);
}

int ListView_InsertColumn(HWND w, int i, LV_COLUMN* p) {
...
int TabCtrl_InsertItem(HWND w, int i, TC_ITEM* p) {
...
BOOL TreeView_SetItem(HWND w, TV_ITEM* i) {
